...
// Description : Sorts a random vector, and searches a random value with binary_search
//				 inside this vector
//============================================================================
...
int main(int argc, char** argv) {
	std::cout << "Hello Mahdi and Dominique!" << std::endl;
	...
	if (pos < 0) {
		...
		std::cout << "\n\n" << search_value << " was found at the " << pos
				<< " position!" << std::endl;
	}
